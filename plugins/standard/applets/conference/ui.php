...
<div class="vbx-applet">
		...
		<h2 style="display:none">Note</h2>
		<p style="display:none">Twilio and Tropo numbers use seperate channels for conferences. You cannot access the same conference through a Tropo and a Twilio number.</p>
