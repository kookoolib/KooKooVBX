...
$caller = normalize_phone_to_E164( isset($_SESSION['From'])? $_SESSION['From'] : '' );
$isModerator = false;
...
//KooKoo conference has lesser options. So just include the conference tag
//$dial = $response->addDial();
//$dial->addConference($confName, $confOptions);
$response->addConference($confName);
