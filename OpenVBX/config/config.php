...
/*
|--------------------------------------------------------------------------
| Use site-wide Javscript?
|--------------------------------------------------------------------------
|
| If you're in production, you want to use the site-wide minimized JS.  If
...
|--------------------------------------------------------------------------
|
| If you're in production, you want to use the site-wide minimized CSS.  If
| you're developing, you'll want to see the plain javascript for debugging.
|
*/
...
|
*/
$config['enable_php_notices'] = FALSE;

/*
|--------------------------------------------------------------------------
| Enable Standard PHP logging
|--------------------------------------------------------------------------
|
| This will log to the standard php error logging configured on the server.
|
*/
...
|--------------------------------------------------------------------------
|
| This will enable the profiler built into code igniter.
|
*/
